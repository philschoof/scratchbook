...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAlbumCover = function getAlbumCover(success, failure, data) {
	  ...
	  var preparedTitle = prepareData(data.album.title);
	  $.ajax({
	...
	module.exports = {
	  ...
	  newAlbumFailure: newAlbumFailure,
	  getAlbums: getAlbums,
	  editAlbum: editAlbum,
