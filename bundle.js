...
/***/ function(module, exports, __webpack_require__) {
	...
	var userUi = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var albumApi = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//Album CRUD
	var newAlbum = function newAlbum(success, failure, data) {
	  $.ajax({
	    method: "POST",
	...
	var displayAlbums = function displayAlbums(albums) {
	  $('.landing-div').hide();
	  $('.content').html('');
	  var albumsDisplayTemplate = __webpack_require__(9);
	...
	var prepareData = function prepareData(name) {
	  name = name.split(' ');
	  name = name.join('+');
	  return name;
	};
	...
	var albumCoverSuccess = function albumCoverSuccess(data) {
	  ...
	  //tests for specific lastFM error image
	      ...
	      //checks for album error or unavailable before calling the patch request
	        ...
	        $('.album-cover-error').text("");
	        var albumCoverValue = data.album.image[3]['#text'];
	...
	module.exports = {
	  ...
	  albumCoverSuccess: albumCoverSuccess,
	  albumCoverPatch: albumCoverPatch,
	  deleteCover: deleteCover,
	  deleteCoverSuccess: deleteCoverSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n\n  <div class=\"row\">\n    <div class=\"panel panel-inverse edit-album\" data-attribute="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + ">\n      <div class=\"panel-body\">\n        <div class=\"col-md-6\">\n          <div class='album-stats'>\n\n            <h3 class=\"album-title\">"
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "</h3>\n            <h4 class=\"album-artist\">"
	    + alias2(alias1((depth0 != null ? depth0.artist : depth0), depth0))
	    + "</h4>\n            <div class=\"album-thoughts\"><p>"
	    + alias2(alias1((depth0 != null ? depth0.thoughts : depth0), depth0))
	  ...
	  return "\n\n<div class=\"row\">\n  <div class=\"panel panel-default open-new-album\">\n    <div class=\"panel-body\">\n      <h3>New Album +</h3>\n    </div>\n  </div>\n</div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.albums : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var albumApi = __webpack_require__(8);
	var albumUi = __webpack_require__(134);
	var getFormFields = __webpack_require__(132);

	var albumEventHandlers = function albumEventHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newAlbumFail = function newAlbumFail(data) {
	  console.log(data);
	...
	module.export = {
	  newAlbumSuccess: newAlbumSuccess,
	  newAlbumFail: newAlbumFail,
	  failure: failure
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(132);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
